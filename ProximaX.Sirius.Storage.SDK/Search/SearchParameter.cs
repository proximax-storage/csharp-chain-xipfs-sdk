...
namespace ProximaX.Sirius.Storage.SDK.Search
{
    public class SearchParameter
    {
        ...
        public SearchParameter(TransactionFilter transactionFilter, int resultSize, string accountAddress,
            string accountPublicKey, string accountPrivateKey, string nameFilter, string descriptionFilter,
            string metadataKeyFilter, string metadataValueFilter, string fromTransactionId)
        {
