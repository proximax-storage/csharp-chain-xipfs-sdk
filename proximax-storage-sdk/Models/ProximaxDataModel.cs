...
namespace Proximax.Storage.SDK.Models
{
    public class ProximaxDataModel : IDataInfoModel
    {
        ...
        public ProximaxDataModel(string digest, string dataHash, string description,
        ...
        public static ProximaxDataModel Create(IDataInfoModel parameterData, string dataHash, string digest,
