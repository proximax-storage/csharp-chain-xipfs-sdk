...
namespace IO.Proximax.SDK.Services.Clients
{
    ...
    {
        public static readonly String STATUS_FOR_SUCCESSFUL_UNCONFIRMED_TRANSACTION = "SUCCESS";
        ...
        public string WaitForAnnouncedTransactionToBeUnconfirmed(Address address, string transactionHash)
        {
            ...
            lock (listener)
            {
                ...
                IObservable<String> failedTransactionStatusOb =
        getAddedFailedTransactionStatus(address, transactionHash, listener);
                IObservable<String> unconfirmedTransactionStatusOb =
